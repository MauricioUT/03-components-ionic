...
export class SlidesPage implements OnInit {
  ...
  constructor( private navCtrl: NavController) { // forma de navegacion entre paginas de ionic similar al router de angular
  ...
  onClick(){
    this.navCtrl.navigateBack('/'); // es similar al ion-back-button, si no encuentra una ruta anterior devuelve al inicio 
  }
}
